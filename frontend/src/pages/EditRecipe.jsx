...
const EditRecipe = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await recipeAPI.updateRecipe(id, formDataToSend);
      navigate(`/recipe/${id}`);
    } catch (error) {
      ...
      <div className="container">
        <div className="create-recipe-container">
          <div className="create-recipe-header">
            <h1 className="create-recipe-title">Edit Recipe</h1>
            <p className="create-recipe-subtitle">Update your culinary masterpiece</p>
          </div>
            ...
            <div className="form-section">
              <div className="form-group">
                ...
                {!imagePreview && currentImage && (
                  <div className="image-preview">
                    <img src={`http://localhost:5001/uploads/${currentImage}`} alt="Current recipe" />
                    <p style={{ textAlign: 'center', marginTop: '0.5rem', color: 'var(--gray-text)' }}>
                      Current image
                    </p>
                  </div>
                )}
